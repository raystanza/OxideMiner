...
- Current v10 host-class status is stricter than this older packaged section:
  same-SHA `ff_*` reruns on `2026-03-18` and `2026-03-20` disagreed on
  realized `large_pages_on` backing and Light superscalar deltas, and the
...
- Clean authority standard is met on AMD `23/8`, Intel `6/45`, and Intel `6/58`.
