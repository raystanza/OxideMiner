...
HOST_TAG="${HOST_TAG:-intel_fam6_mod45}"
...
WORKTREE="${WORKTREE:-/tmp/oxide-randomx-v6_10-${HOST_TAG}-${TS}}"
TMP_OUT="${TMP_OUT:-/tmp/oxide-randomx-v6_10-${HOST_TAG}-out-${TS}}"
FINAL_OUT="${FINAL_OUT:-${ROOT_DIR}/perf_results/Intel}"

MANIFEST_FILE="${TMP_OUT}/v6_10_manifest_${HOST_TAG}_${TS}.txt"
PROVENANCE_FILE="${TMP_OUT}/v6_10_host_provenance_${HOST_TAG}_${TS}.txt"
BENCH_INDEX_FILE="${TMP_OUT}/v6_10_bench_index_${HOST_TAG}_${TS}.csv"
PERF_INDEX_FILE="${TMP_OUT}/v6_10_perf_index_${HOST_TAG}_${TS}.csv"
SUMMARY_FILE="${TMP_OUT}/v6_10_simd_blockio_summary_${HOST_TAG}_${TS}.json"
...
build_examples() {
    ...
    ) > "${TMP_OUT}/v6_10_build_${label}_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_build_${label}_${HOST_TAG}_${TS}.stderr"
...
build_perf_compare() {
    ...
    ) > "${TMP_OUT}/v6_10_build_perf_compare_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_build_perf_compare_${HOST_TAG}_${TS}.stderr"
...
run_test_bundle() {
    ...
    ) > "${TMP_OUT}/v6_10_oracle_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_oracle_${HOST_TAG}_${TS}.stderr"

    (
        cd "${WORKTREE}"
        cargo test --features "jit jit-fastregs" --test oracle
    ) > "${TMP_OUT}/v6_10_oracle_jit_fastregs_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_oracle_jit_fastregs_${HOST_TAG}_${TS}.stderr"

    (
        cd "${WORKTREE}"
        cargo test --features "simd-blockio" --test oracle
    ) > "${TMP_OUT}/v6_10_oracle_simd_blockio_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_oracle_simd_blockio_${HOST_TAG}_${TS}.stderr"

    (
        cd "${WORKTREE}"
        cargo test --features "simd-blockio" simd_prepare_finish_matches_scalar
    ) > "${TMP_OUT}/v6_10_simd_prepare_finish_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_simd_prepare_finish_${HOST_TAG}_${TS}.stderr"

    (
        cd "${WORKTREE}"
        cargo test --features "simd-blockio" simd_blockio_blocked_cpu_classifier_targets_xeon_model_45
    ) > "${TMP_OUT}/v6_10_simd_classifier_${HOST_TAG}_${TS}.stdout" \
      2> "${TMP_OUT}/v6_10_simd_classifier_${HOST_TAG}_${TS}.stderr"
}
...
run_bench_pair() {
    ...
    local out_csv="${TMP_OUT}/v6_10_bench_${mode}_${pair_label}_${HOST_TAG}_${TS}.csv"
    local raw_log="${TMP_OUT}/v6_10_bench_${mode}_${pair_label}_${HOST_TAG}_${TS}.raw.log"
...
run_perf_once() {
    ...
    local out_csv="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${config_label}_${seq}_${HOST_TAG}_${TS}.csv"
    local out_stdout="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${config_label}_${seq}_${HOST_TAG}_${TS}.stdout"
    local out_stderr="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${config_label}_${seq}_${HOST_TAG}_${TS}.stderr"
...
run_perf_compare() {
    ...
    local out_path="${TMP_OUT}/v6_10_perf_compare_${label}_${HOST_TAG}_${TS}.txt"
...
run_perf_pair() {
    ...
    local left_combined="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${left_label}_combined_${HOST_TAG}_${TS}.csv"
    local right_combined="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${right_label}_combined_${HOST_TAG}_${TS}.csv"
    local pair_combined="${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_pair_matrix_${HOST_TAG}_${TS}.csv"

    combine_csv "${left_combined}" \
        "${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${left_label}_a1_${HOST_TAG}_${TS}.csv" \
        "${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${left_label}_a2_${HOST_TAG}_${TS}.csv"
    combine_csv "${right_combined}" \
        "${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${right_label}_b1_${HOST_TAG}_${TS}.csv" \
        "${TMP_OUT}/v6_10_perf_${mode}_${pair_label}_${right_label}_b2_${HOST_TAG}_${TS}.csv"
...
export V6_10_TS="${TS}"
export V6_10_HOST_TAG="${HOST_TAG}"
export V6_10_HEAD_SHA="${HEAD_SHA}"
export V6_10_VENDOR_ID="${VENDOR_ID}"
export V6_10_CPU_FAMILY="${CPU_FAMILY}"
export V6_10_CPU_MODEL="${CPU_MODEL}"
export V6_10_CPU_MODEL_NAME="${CPU_MODEL_NAME}"
export V6_10_THREADS="${THREADS}"
export V6_10_BENCH_ITERS="${BENCH_ITERS}"
export V6_10_BENCH_WARMUP="${BENCH_WARMUP}"
export V6_10_BENCH_REPEATS="${BENCH_REPEATS}"
export V6_10_PERF_ITERS="${PERF_ITERS}"
export V6_10_PERF_WARMUP="${PERF_WARMUP}"
export V6_10_LARGE_PAGES="${LARGE_PAGES}"
export V6_10_FINAL_OUT="${FINAL_OUT}"
export V6_10_BENCH_INDEX_FILE="${BENCH_INDEX_FILE}"
export V6_10_PERF_INDEX_FILE="${PERF_INDEX_FILE}"
export V6_10_SUMMARY_FILE="${SUMMARY_FILE}"
export V6_10_MANIFEST_FILE="${MANIFEST_FILE}"
export V6_10_PROVENANCE_FILE="${PROVENANCE_FILE}"
...
bench_rows_by_key = {}
bench_meta_by_key = {}
with open(os.environ["V6_10_BENCH_INDEX_FILE"], newline="") as f:
...
with open(os.environ["V6_10_PERF_INDEX_FILE"], newline="") as f:
    for meta in csv.DictReader(f):
...
for (mode, pair_label), runs in perf_rows_by_key.items():
    ...
    perf_summary.setdefault(mode, {})[pair_label] = {
        ...
        "perf_compare_artifact": rel(
            f"v6_10_perf_compare_{mode}_{pair_label}_{os.environ['V6_10_HOST_TAG']}_{os.environ['V6_10_TS']}.txt"
        ),
    }

summary = {
    "ts": os.environ["V6_10_TS"],
    "host_tag": os.environ["V6_10_HOST_TAG"],
    "head_sha": os.environ["V6_10_HEAD_SHA"],
    "host": {
        "vendor_id": os.environ["V6_10_VENDOR_ID"],
        "cpu_family": int(os.environ["V6_10_CPU_FAMILY"]),
        "cpu_model": int(os.environ["V6_10_CPU_MODEL"]),
        "cpu_model_name": os.environ["V6_10_CPU_MODEL_NAME"],
        "blocked_cpu_match": (
            os.environ["V6_10_VENDOR_ID"] == "GenuineIntel"
            and os.environ["V6_10_CPU_FAMILY"] == "6"
            and os.environ["V6_10_CPU_MODEL"] == "45"
        ),
        "novelty": "duplicate_family_confirmation",
        "supports_classifier_broadening": False,
    },
    "params": {
        "threads": int(os.environ["V6_10_THREADS"]),
        "large_pages": os.environ["V6_10_LARGE_PAGES"],
        "bench": {
            "iters": int(os.environ["V6_10_BENCH_ITERS"]),
            "warmup": int(os.environ["V6_10_BENCH_WARMUP"]),
            "repeats": int(os.environ["V6_10_BENCH_REPEATS"]),
        },
        "perf": {
            "iters": int(os.environ["V6_10_PERF_ITERS"]),
            "warmup": int(os.environ["V6_10_PERF_WARMUP"]),
        },
    },
    "bench": bench_summary,
    "perf": perf_summary,
    "artifacts": {
        "manifest": rel(os.environ["V6_10_MANIFEST_FILE"]),
        "provenance": rel(os.environ["V6_10_PROVENANCE_FILE"]),
        "bench_index": rel(os.environ["V6_10_BENCH_INDEX_FILE"]),
        "perf_index": rel(os.environ["V6_10_PERF_INDEX_FILE"]),
        "summary": rel(os.environ["V6_10_SUMMARY_FILE"]),
    },
}

with open(os.environ["V6_10_SUMMARY_FILE"], "w") as f:
    json.dump(summary, f, indent=2)
    f.write("\n")
PY

cp "${MANIFEST_FILE}" "${PROVENANCE_FILE}" "${BENCH_INDEX_FILE}" "${PERF_INDEX_FILE}" "${SUMMARY_FILE}" "${FINAL_OUT}/"
cp "${TMP_OUT}"/v6_10_*_"${HOST_TAG}"_"${TS}".csv "${FINAL_OUT}/"
cp "${TMP_OUT}"/v6_10_*_"${HOST_TAG}"_"${TS}".stdout "${FINAL_OUT}/"
cp "${TMP_OUT}"/v6_10_*_"${HOST_TAG}"_"${TS}".stderr "${FINAL_OUT}/"
cp "${TMP_OUT}"/v6_10_*_"${HOST_TAG}"_"${TS}".txt "${FINAL_OUT}/"
cp "${TMP_OUT}"/v6_10_*_"${HOST_TAG}"_"${TS}".raw.log "${FINAL_OUT}/"
