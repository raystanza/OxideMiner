...
- `simd-blockio` and `simd-xor-paths` remain fenced experimental features,
  `threaded-interp` remains a closed negative result, and
  `superscalar-accel-proto` remains the only active research lane; all stay off
  by default.
